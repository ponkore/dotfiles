...
typeset -g _zim_fpath=($ZIM_HOME/modules/git/functions $ZIM_HOME/modules/utility/functions $ZIM_HOME/modules/duration-info/functions $ZIM_HOME/modules/git-info/functions $ZIM_HOME/modules/zsh-completions/src)
...
source $ZIM_HOME/modules/eriner/eriner.zsh-theme
